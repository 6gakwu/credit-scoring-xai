"""
RQ2, part 2 - XGBoost, SHAP similarity stability. Same approach as the
other SHAP versions.
"""
...
def main():
    ...
    anchor_explanations = pd.read_csv(EXPLAIN_DIR / "shap_xgboost.csv").set_index("SK_ID_CURR")
    ...
    neighbor_explanations.to_csv(SIMILARITY_DIR / "shap_xgboost_neighbors.csv")
    print(f"Saved neighbor explanations to {SIMILARITY_DIR / 'shap_xgboost_neighbors.csv'}")
