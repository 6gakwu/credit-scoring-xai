"""
RQ2, part 2 - XGBoost, LIME similarity stability. Same approach as the
other LIME versions. 
"""
...
def main():
    ...
    anchor_explanations = pd.read_csv(EXPLAIN_DIR / "lime_xgboost.csv").set_index("SK_ID_CURR")
    ...
    neighbor_explanations.to_csv(SIMILARITY_DIR / "lime_xgboost_neighbors.csv")
    print(f"\nSaved neighbor explanations to {SIMILARITY_DIR / 'lime_xgboost_neighbors.csv'}")
