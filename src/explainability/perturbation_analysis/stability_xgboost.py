"""
RQ1, part 2 - XGBoost perturbation stability. 
"""
...
def main():
    ...
    original_explanations = pd.read_csv(EXPLAIN_DIR / "shap_xgboost.csv")
    ...
    raw_output_path = PERTURB_DIR / "shap_xgboost_perturbed.csv"
    ...
    scores_path = PERTURB_DIR / "stability_scores_shap_xgboost.csv"
    scores_df.to_csv(scores_path, index=False)
    print(f"Saved per-applicant stability scores to {scores_path}")

    print(f"\nXGBoost - SHAP perturbation stability")
