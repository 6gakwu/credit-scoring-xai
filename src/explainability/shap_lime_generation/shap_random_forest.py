...
Same probability-based approach as the previous two models, for the
same reason. No scalerneeded, same as Decision Tree.
...
def main():
    ...
    output_path = EXPLAIN_DIR / "shap_random_forest.csv"
