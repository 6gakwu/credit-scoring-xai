...
Same approach as all 3 previous models, kept identical -
probability-based wrapper for consistent units across all 4 models, same
200-applicant sample, same 100-applicant background reference. No
scaler needed.
...
def main():
    ...
    output_path = EXPLAIN_DIR / "shap_xgboost.csv"
