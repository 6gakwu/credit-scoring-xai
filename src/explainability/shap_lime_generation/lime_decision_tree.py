...
Same approach as Logistic Regression - one applicant at a time,
discretize_continuous=False to keep one clean number per feature. No
scaler here, same reasoning as the SHAP Decision Tree script
"""
...
def main():
    ...
    output_path = EXPLAIN_DIR / "lime_decision_tree.csv"
